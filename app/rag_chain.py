...
vector_store = PGVector(
    ...
    connection_string="postgresql+psycopg://bidhanbashyal@localhost:5432/database164",
...
postgres_memory_url = "postgresql+psycopg://bidhanbashyal:postgres@localhost:5432/pdf_rag_history"
