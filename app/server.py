...
app.mount("/rag/static", StaticFiles(directory="/Users/bidhanbashyal/Projects/Langchain/level3/rag-app/fullapp/pdf-documents"), name="static")
@app.get("/")
async def redirect_root_to_docs():
    return RedirectResponse("/docs")

pdf_directory = "/Users/bidhanbashyal/Projects/Langchain/level3/rag-app/fullapp/pdf-documents"
...
async def load_and_process_pdfs():
    try:
        subprocess.run(["python", "/Users/bidhanbashyal/Projects/Langchain/level3/rag-app/fullapp/rag-data-loader/rag_load_and_process.py"], check=True)
